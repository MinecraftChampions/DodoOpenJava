...
public class MongoDBData {
    ...
    public void initPermissions(String host, int port) {
        ...
        for (String listCollectionName : listUserCollectionNames) {
            ...
            for (int I = 0; I < io.github.minecraftchampions.dodoopenjava.permissions.Group.getGroups().size(); I++) {
                if (Objects.equals(io.github.minecraftchampions.dodoopenjava.permissions.Group.getGroups().get(I).getName(), getUserGroup(listCollectionName))) {
    ...
    public Boolean modifyDefaultPermGroup(String Group) {
        ...
        if (Objects.equals(io.github.minecraftchampions.dodoopenjava.permissions.Group.getDefaultGroup().getName(), Group)) {
            isDefault = true;
        } else {
            MongoCollection<Document> collection = permGroup.getCollection(io.github.minecraftchampions.dodoopenjava.permissions.Group.getDefaultGroup().getName());
