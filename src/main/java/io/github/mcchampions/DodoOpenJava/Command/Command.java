...
public class Command {
     ...
     * @param args 命令参数
     */
    public static Boolean trigger(CommandSender sender, String commandName, String[] args) {
        boolean hasCommand = false;
        for (CommandExecutor command :commands) {
            if (Objects.equals(command.MainCommand().utf8(), ByteString.encodeUtf8((commandName)).utf8())) {
